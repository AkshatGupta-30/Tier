...
const Site = ({ site, topSite: isTopSite }: ISiteProps) => {
  ...
  return (
    <a
      ...
      className="group gap-auto relative flex w-full cursor-pointer flex-col items-center justify-start transition-all duration-300 hover:-translate-y-1 hover:drop-shadow-lg"
    >
