...
const Header = () => {
  ...
  return (
    <header className="sticky top-4 z-50 mx-auto mt-4 flex w-full max-w-7xl items-center justify-between rounded-2xl bg-white/10 p-2.5 shadow-lg ring-1 shadow-black/5 ring-white/20 backdrop-blur-xl transition-all duration-300 dark:bg-black/40 dark:shadow-black/20 dark:ring-white/10">
